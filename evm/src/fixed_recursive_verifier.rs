...
use crate::recursive_verifier::{
    recursive_stark_circuit, PlonkWrapperCircuit, PublicInputs, StarkWrapperCircuit,
};
    ...
    [(); MemoryStark::<F, D>::COLUMNS]:,
{
    pub fn new(
        ...
        let inner_common_data = &by_table[0].final_circuits()[0].common;

        let mut builder = CircuitBuilder::new(CircuitConfig::standard_recursion_config());
        let recursive_proofs =
            std::array::from_fn(|_i| builder.add_virtual_proof_with_pis::<C>(inner_common_data));
        ...
        for (i, table_circuits) in by_table.iter().enumerate() {
            ...
            debug_assert!(
                final_circuits
                    .iter()
                    .all(|c| &c.common == inner_common_data),
                "Not all final circuits matched"
            );
            let possible_vks = final_circuits
                .into_iter()
    ...
    pub fn prove_root(
        ...
        for table in 0..NUM_TABLES {
            ...
            let shrunk_proof =
                table_circuits.by_stark_size[&original_degree_bits].shrink(stark_proof)?;
    ...
    [(); C::Hasher::HASH_SIZE]:,
{
        ...
        [(); S::COLUMNS]:,
    {
        ...
        log::info!("Starting at {}", 1 << initial_wrapper.circuit.common.degree_bits()); // TODO
        ...
        loop {
            ...
            dbg!(proof_with_pis_target.public_inputs.len());
    ...
    fn shrink(
        ...
        let mut proof = self.initial_wrapper.prove(stark_proof)?;
